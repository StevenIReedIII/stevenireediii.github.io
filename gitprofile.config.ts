...
const CONFIG = {
  github: {
    username: 'STEVENIREEDIII', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Steven Reed',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'steven-reed-iii',
    ...
    reddit: '',
    threads: '',
    youtube: 'StevieGoggins', // example: 'pewdiepie'
    udemy: '',
    dribbble: '',
    behance: '',
    medium: 'sreeds2018',
  ...
  experiences: [
    {
      company: 'BrockISD Technology',
      position: 'Intern',
      from: 'June 2023',
      to: 'December 2023',
      companyLink: 'https://brockisd.net',
    },
  ],
  certifications: [
    {
  ...
  blog: {
    ...
    username: 'sreeds2018', // to hide blog section, keep it empty
